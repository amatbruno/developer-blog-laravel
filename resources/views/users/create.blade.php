...
<main class="flex flex-col items-center justify-center h-[100vh] m-0">
    <h1 class="text-white text-5xl text-center pb-8 font-bold mb-5 w-[350px] mt-[-50px]">Create your Sphere account</h1>
    <div class="border-2 border-white p-10 rounded-xl">
